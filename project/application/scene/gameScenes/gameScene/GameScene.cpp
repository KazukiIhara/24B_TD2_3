...
void GameScene::Initialize() {
	...
	light_->GetPunctualLight().pointLight.position = moon_->GetTranslate();
	...
	light_->GetPunctualLight().spotLight.direction = Normalize(moon_->GetTranslate() - sceneCamera_->GetWorldPos());
